...
export default function CommunityPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      >
        <div>
          <h1 className="text-4xl font-bold mb-2 text-gradient-blue">Couples Community</h1>
          <p className="text-gray-400">Connect with other couples on the same journey</p>
        </div>
        <button
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-semibold">Anonymous Couple</div>
